...
class SynAnimalTiger(Animal18KeypointDataset):
    ...
    .. note::
        ...
        ::
            ...
            annotations/
                ...
                ...
    """
    def __init__(self, root, split='tiger', task='all', download=True, **kwargs):
        ...
        super(SynAnimalTiger, self).__init__(root, samples, **kwargs)
    ...
    def preprocess(self, part, root):
        ...
        print(os.path.join(data_dir, 'synthetic_animal', part + '_combineds5r5_texture', '*img.png'))
        img_list = glob.glob(os.path.join(data_dir, 'synthetic_animal', part + '_combineds5r5_texture', '*img.png'))
        ...
        for i, image_data in enumerate(tqdm.tqdm(img_list)):
            ...
            src_image_path = image_data
            tgt_image_path = os.path.join(root, "crop_images", image_data.rsplit('/', 1)[1])
